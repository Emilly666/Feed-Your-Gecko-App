...
public class HomeViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final int VIEW_TYPE_ITEM_FEED = 0;
    private final int VIEW_TYPE_ITEM_VITAMINS = 1;
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(@NonNull View itemView) {
            ...
            linear = itemView.findViewById(R.id.reptileDescription);
    ...
    private void populateItemRows(ItemViewHolder viewHolder, int position) {
        ...
        int icon;
        if(mItemList.get(position).getType() == VIEW_TYPE_ITEM_FEED){
            icon = R.drawable.food;
        }else{
            icon = R.drawable.vitamins;
        }
